...
function showFinalMessage(){
    ...
    if(score >= (questions.length * 70) / 100){
        ...
        message = `Oops! You did not completed the Quiz. <br> You Answered only ${score} Questions Correctly Out of ${questions.length} Questions`;
    }else{
        message = `Oops! You did not Answer Any Questions`; 
    }
